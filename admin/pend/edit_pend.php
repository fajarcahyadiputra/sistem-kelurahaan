	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="kewarganegaraan" name="kewarganegaraan" value="<?php echo $data_cek['kewarganegaraan']; ?>" placeholder="Kewarganegaraan" required>
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Pendidikan *<small class="text-info">Terakhir</small></label>
				<div class="col-sm-6">
					<input type="text" class="form-control" id="pendidikan" name="pendidikan" value="<?php echo $data_cek['pendidikan']; ?>" placeholder="pendidikan" required>
				</div>
			</div>
			<div class="form-group row">
