	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<font color="white">
							<b>SISTEM INFORMASI ADMINISTRASI KEPENDUDUKAN KELURAHAN TELAGA ASIH</b>
						</font>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				...
				<span class="brand-text"> SIAK TELAGA ASIH</span>
			</a>
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<!-- Level  -->
						<?php
          if ($data_level=="Administrator" || $data_level=="lurah"){
        ?>
						<li class="nav-item">
							<a href="index.php" class="nav-link">
    ...
    ?>
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				Copyright &copy;
				<a target="_blank" href="https://wa.me/6289674688407">
					<strong> Siti Nurwiyah</strong>
				</a>
				All rights reserved.
			</div>
			<b>SISTEM INFORMASI KEPENDUDUKAN</b>
		</footer>
